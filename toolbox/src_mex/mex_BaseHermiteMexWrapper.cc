...
namespace Splines
{
  ...
  static void do_base( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_base_D( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_base_DD( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_base_DDD( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#define CMD MEX_ERROR_MESSAGE_5
    ...
    {
      Hermite3( t[i], H, tmp );
      for ( mwSize j{ 0 }; j < nr2; ++j ) *out++ = tmp[0] * P0[j] + tmp[1] * P1[j] + tmp[2] * T0[j] + tmp[3] * T1[j];
    }
#undef CMD
  }
...
#undef CMD
  ...
  static void do_hermite_to_bezier( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_bezier_to_hermite( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_L2_first_derivative( int nlhs, mxArray * plhs[], int nrhs, mxArray const *[] )
  {
...
#undef CMD
  ...
  static void do_L2_second_derivative( int nlhs, mxArray * plhs[], int nrhs, mxArray const *[] )
  {
...
#undef CMD
  ...
  static void do_L2_third_derivative( int nlhs, mxArray * plhs[], int nrhs, mxArray const *[] )
  {
...
#undef CMD
  ...
  static void do_base5( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_base5_D( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_base5_DD( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_base5_DDD( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_base5_DDDD( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_base5_DDDDD( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_eval5( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#define CMD MEX_ERROR_MESSAGE_20
    ...
    for ( mwSize i{ 0 }; i < nr; ++i )
    {
      ...
      for ( mwSize j{ 0 }; j < nr2; ++j )
        *out++ = tmp[0] * P0[j] + tmp[1] * P1[j] + tmp[2] * T0[j] + tmp[3] * T1[j] + tmp[4] * J0[j] + tmp[5] * J1[j];
    }
#undef CMD
  }
  ...
  static void do_eval5_D( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_eval5_DD( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_eval5_DDD( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_eval5_DDDD( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_eval5_DDDDD( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_cut( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#undef CMD
  ...
  static void do_approximate_length( int nlhs, mxArray * plhs[], int nrhs, mxArray const * prhs[] )
  {
...
#define CMD MEX_ERROR_MESSAGE_27
    ...
    double A[4];
    Hermite3( 0, H, A );
    for ( mwSize j{ 0 }; j < nr1; ++j ) P[j] = A[0] * P0[j] + A[1] * P1[j] + A[2] * T0[j] + A[3] * T1[j];

...
namespace Splines
{
  ...
  public:
    ...
    //! of the spline: \f$ S_x(x,y) \f$.
    //!
    real_type eval_D_1( real_type const x, real_type const y, real_type const s ) const { return this->Dx( x, y, s ); }

    //!
    //! First derivatives respect to \f$ y \f$ at point \f$ (x,y) \f$
    //! of the spline: \f$ S_x(x,y) \f$.
    //!
    real_type eval_D_2( real_type const x, real_type const y, real_type const s ) const { return this->Dy( x, y, s ); }

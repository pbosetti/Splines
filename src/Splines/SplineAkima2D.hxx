...
#ifndef SPLINE_AKIMA2D_HH
#define SPLINE_AKIMA2D_HH
...
namespace Splines
{
  ...
  class Akima2Dspline : public BiCubicSplineBase
  {
    void make_spline() override
    {
      UTILS_ASSERT(
        m_nx >= 2 && m_ny >= 2,
        "Akima2Dspline::make_spline, nx={}, ny={} mus be nx >= 2 and ny >= 2",
        m_nx,
        m_ny );
...
#define DEBUG_AKIMA
  ...
  public:
    ...
    //! Spline destructor.
    //!
    ~Akima2Dspline() override = default;
    ...
    char const * type_name() const override { return "Akima2D"; }
  };

}  // namespace Splines

#endif  // SPLINE_AKIMA2D_HH

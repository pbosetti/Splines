...
namespace Splines
{
  ...
  void QuinticSplineBase::reserve_external(
    integer const n,
    real_type *&  p_x,
    real_type *&  p_y,
    real_type *&  p_Yp,
  ...
  void QuinticSplineBase::reserve( integer const npts )
  {
  ...
  real_type QuinticSplineBase::eval( real_type const x ) const
  {
  ...
  real_type QuinticSplineBase::D( real_type const x ) const
  {
    std::pair<integer, real_type> res( 0, x );
    m_search.find( res );
  ...
  real_type QuinticSplineBase::DD( real_type const x ) const
  {
    std::pair<integer, real_type> res( 0, x );
    m_search.find( res );
  ...
  real_type QuinticSplineBase::id_DDD( integer const i, real_type const x ) const
  {
    if ( m_curve_can_extend && m_curve_extended_constant )
    {
      if ( x < m_X[0] || x > m_X[m_npts - 1] ) return 0;
  ...
  real_type QuinticSplineBase::DDD( real_type const x ) const
  {
    std::pair<integer, real_type> res( 0, x );
    m_search.find( res );
  ...
  real_type QuinticSplineBase::DDDD( real_type const x ) const
  {
    std::pair<integer, real_type> res( 0, x );
    m_search.find( res );
  ...
  real_type QuinticSplineBase::DDDDD( real_type const x ) const
  {
    std::pair<integer, real_type> res( 0, x );
    m_search.find( res );
  ...
  integer  // order
  QuinticSplineBase::coeffs( real_type cfs[], real_type nodes[], bool const transpose ) const
  {
  ...
  integer QuinticSplineBase::order() const
  {
    return 6;
  }

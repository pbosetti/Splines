...
namespace Splines
{
  ...
  */
  ...
  real_type first_deriv4p_R(
    real_type const DLLL,
    ...
    real_type const hL )
  {
    ...
    real_type const top =
      ( ( DLLL - DLL ) * t2 + 4 * t19 * DL - 3 * t19 * DLL + t19 * DLLL + 6 * hLL * t22 * hLLL + 2 * t22 * t26 ) * hL +
  ...
  real_type first_deriv4p_L(
    real_type const DR,
    real_type const hR,
    real_type const DRR,
    real_type const hRR,
    real_type const DRRR,
    real_type const hRRR )
  {
    ...
    real_type const t33{ t32 * t32 };
    real_type const top{
      ( ( DRRR - DRR ) * t2 + t19 * ( 4 * DR - 3 * DRR + DRRR ) + 6 * hRR * t22 * hRRR + 2 * t22 * t26 ) * hR +
    ...
    real_type const hRR )
  {
    ...
    real_type const top{
      ( ( hhRR * t10 - t12 * t14 + t3 * t4 ) * hhLL + hhRR * t26 + ( hR * t24 - hL * t22 ) * DDRR + t20 * t3 ) * t17 +
    ...
    real_type const hRR )
  {
    ...
    real_type       top;
    {
      ...
      top = ( ( ( 4 * t16 * t41 + t12 * t25 ) * hhRR + 4 * ( t12 * t28 - t14 * t41 ) * hR +
                hhLL * ( t14 * t25 + 4 * t16 * t28 ) + t21 * t1 + t38 * t3 - t5 * t48 ) *
                t8 +
              hhRR * t3 * t9 - hR * t5 * t9 + ( 2 * DL - DDLL ) * t16 * t14 * t70 + hhLL * t1 * t9 + t21 * t14 * t80 -
              2 * t21 * t16 * t83 + t12 * ( t38 * t80 - 2 * t48 * t83 ) ) *
              hL +
            t8 * ( t52 * hR * t51 + hhRR * ( t55 * t21 + t55 * t51 ) - 3 * t21 * hR * t58 +
                   ( -t38 * t55 + 3 * t48 * t58 ) * hhLL ) +
    ...
    real_type const hRR )
  {
    ...
    real_type       top;
    {
      ...
      top = ( ( ( 4 * t16 * t41 + t12 * t25 ) * hhRR + ( -4 * t12 * t28 + 4 * t14 * t41 ) * hL +
                hhLL * ( t14 * t25 + 4 * t16 * t28 ) + t21 * t1 + t38 * t3 + t5 * t48 ) *
                t8 +
              hhRR * t3 * t9 + hL * t5 * t9 + ( -2 * DR + DDLL ) * t16 * t14 * t73 + hhLL * t1 * t9 + t21 * t14 * t80 -
              2 * t21 * t16 * t83 + t12 * ( t38 * t80 + 2 * t48 * t83 ) ) *
              hR +
            t8 * ( t49 * hL * t73 * t47 + hhRR * ( -t53 * t73 * t47 + t55 * t21 ) - 3 * t21 * t58 * hL +
                   ( -t38 * t55 + 3 * t48 * t58 ) * hhLL ) -
            t105 * t73 * t103 * hhRR * DR * hL * hhLL + 2 * t9 * ( t5 * t16 + t12 * t1 - t14 * t3 );
    }
    ...
    real_type const dpR )
  {
    ...
    real_type const hR2{ hR * hR };
    real_type const hR4{ hR2 * hR2 };
    real_type const top{ hL4 * ( 4 * SR - 2 * ( dp0 + dpR ) ) + hR4 * ( 6 * SL - 2 * dp0 - 4 * dpL ) +
                         hL2 * hR2 * ( 20 * SL - 12 * dp0 - 8 * dpL ) + hLR * hR2 * ( 20 * SL - 8 * dp0 - 12 * dpL ) +
    ...
    real_type const dpR )
  {
    ...
    real_type const hR2{ hR * hR };
    real_type const hR4{ hR2 * hR2 };
    real_type const top{ hL4 * ( 2 * dp0 + 4 * dpR - 6 * SR ) + hR4 * ( 2 * ( dp0 + dpL ) - 4 * SL ) -
                         hL2 * hLR * ( 20 * SR - 8 * dp0 - 12 * dpR ) - hL2 * hR2 * ( 20 * SR - 12 * dp0 - 8 * dpR ) -
  ...
  void first_derivative_build( real_type const X[], real_type const Y[], real_type Yp[], integer const npts )
  {

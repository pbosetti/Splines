...
namespace Splines
{
  ...
  void ConstantSpline::reserve_external( integer const n, real_type *& p_x, real_type *& p_y )
  {
  ...
  real_type ConstantSpline::eval( real_type x ) const
  {
  ...
  //! Evalute spline value at `x`
  real_type ConstantSpline::id_eval( integer const ni, real_type ) const
  {
    return m_Y[ni];
  }
  ...
  void ConstantSpline::D( real_type const x, real_type dd[2] ) const
  {
    dd[0] = eval( x );
    dd[1] = 0;
  }
  ...
  void ConstantSpline::DD( real_type const x, real_type dd[3] ) const
  {
    dd[0] = eval( x );
    dd[1] = 0;
    dd[2] = 0;
  ...
  autodiff::dual1st ConstantSpline::eval( autodiff::dual1st const & x ) const
  {
  ...
  autodiff::dual2nd ConstantSpline::eval( autodiff::dual2nd const & x ) const
  {

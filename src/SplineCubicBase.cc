...
namespace Splines
{
  ...
  void CubicSplineBase::build( vector<real_type> const & x, vector<real_type> const & y, vector<real_type> const & yp )
  {
  ...
  void CubicSplineBase::reserve( integer const npts )
  {
  ...
  void CubicSplineBase::reserve_external( integer const n, real_type *& p_x, real_type *& p_y, real_type *& p_dy )
  {
    m_npts_reserved  = n;
    m_X              = p_x;
    m_Y              = p_y;
  ...
  real_type CubicSplineBase::eval( real_type x ) const
  {
  ...
  real_type CubicSplineBase::D( real_type const x ) const
  {
    std::pair<integer, real_type> res( 0, x );
    m_search.find( res );
  ...
  real_type CubicSplineBase::DD( real_type const x ) const
  {
    std::pair<integer, real_type> res( 0, x );
    m_search.find( res );
  ...
  real_type CubicSplineBase::DDD( real_type const x ) const
  {
    std::pair<integer, real_type> res( 0, x );
    m_search.find( res );
  ...
  integer  // order
  CubicSplineBase::coeffs( real_type cfs[], real_type nodes[], bool const transpose ) const
  {
  ...
  integer CubicSplineBase::order() const
  {
    return 4;
  }
  ...
  void CubicSplineBase::set_range( real_type const xmin, real_type const xmax )
  {

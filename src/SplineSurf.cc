...
namespace Splines
{
  ...
  void SplineSurf::make_derivative_x( real_type const z[], real_type dx[] )
  {
  ...
  void SplineSurf::make_derivative_y( real_type const z[], real_type dy[] )
  {
    PchipSpline pchip_work;
  ...
  void SplineSurf::make_derivative_xy( real_type const dx[], real_type const dy[], real_type dxy[] )
  {
    PchipSpline pchip_work;
  ...
  //! \name Autodiff
  //!
  autodiff::dual1st SplineSurf::eval( autodiff::dual1st const & x, autodiff::dual1st const & y ) const
  {
  ...
  autodiff::dual2nd SplineSurf::eval( autodiff::dual2nd const & x, autodiff::dual2nd const & y ) const
  {

...
namespace Splines
{
  ...
  //!
  void SplineSet::eval2( vec_real_type const & zetas, integer const indep, GenericContainer & gc ) const
  {
  ...
  */
  ...
  //! as independent spline
  //!
  void SplineSet::eval2_D( vec_real_type const & zetas, integer const indep, GenericContainer & gc ) const
  {
    integer const npts{ static_cast<integer>( zetas.size() ) };
    map_type &    vals{ gc.set_map() };
  ...
  */
  ...
  //! as independent spline
  //!
  void SplineSet::eval2_DD( vec_real_type const & zetas, integer const indep, GenericContainer & gc ) const
  {
    integer const npts{ static_cast<integer>( zetas.size() ) };
    map_type &    vals{ gc.set_map() };
  ...
  */
  ...
  //! as independent spline
  //!
  void SplineSet::eval2_DDD( vec_real_type const & zetas, integer const indep, GenericContainer & gc ) const
  {
    integer const npts{ static_cast<integer>( zetas.size() ) };
    map_type &    vals{ gc.set_map() };

...
int main()
{
  ...
  for ( integer k{ 0 }; k < 7; ++k )
  {
    ...
    {
      case 0:
        xx = xx0; yy = yy0; dataset_name = "Akima Test 0"; break;
      case 1:
        xx = xx1; yy = yy1; dataset_name = "Akima Test 1"; break;
      case 2:
        xx = xx2; yy = yy2; dataset_name = "Akima Test 2"; break;
      case 3:
        xx = xx3; yy = yy3; dataset_name = "RPN 14"; break;
      case 4:
        xx = xx4; yy = yy4; dataset_name = "Titanium"; break;
      case 5:
        xx = xx5; yy = yy5; dataset_name = "Toolpath"; break;
      case 6:
        xx = xx6; yy = yy6; dataset_name = "Monotone"; break;
    }
    ...
    for ( integer spline_idx = 0; spline_idx < nspl; ++spline_idx ) {
      string spline_name = string(ss.header( spline_idx ));  // CORRETTO: conversione esplicita da string_view a string
    ...
    fmt::print( fg(fmt::color::blue), "\nPunti testati: {} ({} nodi + {} punti interni)\n\n", 
                test_points.size(), npts, internal_points );
  }

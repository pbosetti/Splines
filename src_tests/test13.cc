...
constexpr double z[] = { 24.2, 24.0, 20.3, 17.3, 14.5, 12.2, 10.2, 5.7,  3.4,  0.1,  28.0, 24.6, 21.1, 18.1, 15.2,
...
template <typename Tsurf> static void do_test( string const & msg )
{
